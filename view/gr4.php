          ...
          <!-- <div class="card" > -->
            <div class="card-body">
                <div class="d-flex m-b-30 align-items-center no-block">
                    <h5 class="card-title "><i class="fa fa-book"></i>&nbsp;&nbsp;Grafik Top Realisasi Anggaran  <?php echo $tahun;?></h5>
                    <div class="ml-auto">
...
$merk  = mysqli_query($koneksi, "SELECT NAMA,SUM(RealisasiAnggaran) as zz FROM t_belanja where TahunAnggaran='".$tahun."' group by KdPptk order by zz DESC limit 5");
	/* Getting demo_viewer table data */
	$sql = "SELECT SUM(RealisasiAnggaran) as xx FROM t_belanja  where TahunAnggaran='".$tahun."'
	...
	$sql = "SELECT SUM(PaguAnggaran) as count, SUM(RealisasiAnggaran) as vv FROM t_belanja  where TahunAnggaran='".$tahun."'
...
<?php
  ...
  left join t_belanja b ON b.KdPptk = a.KodePptk  and b.TahunAnggaran=$tahun
