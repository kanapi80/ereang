...
<body class="skin-default-dark fixed-layout">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse">
                    <ul class="navbar-nav mr-auto">
                       ...
                       <!-- <li class="nav-item hidden-sm-up "> <a class="nav-link nav-toggler waves-effect waves-light zoom outline-success" href="view.php?link=#"><i class="fa fa-home" style="font-size: 24px;color:#0a9f92"></i></a></li>
                        <li class="nav-item hidden-sm-up "> <a class="nav-link nav-toggler waves-effect waves-light zoom outline-success" href="view.php?link=RBA"><i class="fa fa-bar-chart" style="font-size: 24px;color:#0a9f92"></i></a></li>
                        <li class="nav-item hidden-sm-up "> <a class="nav-link nav-toggler waves-effect waves-light zoom outline-success" href="view.php?link=REALISASI"><i class="fa fa-bar-chart-o" style="font-size: 24px;color:#0a9f92"></i></a></li>
                        <li class="nav-item hidden-sm-up "> <a class="nav-link nav-toggler waves-effect waves-light zoom outline-success" href="view.php?link=DETAIL"><i class="fa fa-book" style="font-size: 24px;color:#0a9f92"></i></a></li>
                        <li class="nav-item hidden-sm-up "> <a class="nav-link nav-toggler waves-effect waves-light zoom outline-success" href="view.php?link=TOP"><i class="fa fa-user-md" style="font-size: 24px;color:#0a9f92"></i></a></li>-->
                        <!-- <li class="nav-item search-box"> <a class="nav-link waves-effect waves-dark"
                            ...
                            <!-- <li class="nav-item hidden-sm-up"> <a class="nav-link nav-toggler waves-effect waves-light" href="view.php?link=#" aria-expanded="false">
                           <span class="hide-menu"> <img src="view/realisasi.png" alt="homepage" class="dark-logo" height="30px" /> </span></a></li>
                        </li>
                        <li class="nav-item hidden-sm-up"> <a class="nav-link nav-toggler waves-effect waves-light" href="view.php?link=TOP" aria-expanded="false">
                           <span class="hide-menu"> <img src="view/top.png" alt="homepage" class="dark-logo" height="30px" /> </span></a></li>
                        </li>

                        <li class="nav-item hidden-sm-up"> <a class="waves-effect waves-dark" href="view.php?link=#" >
            <i class="fa fa-tachometer"></i></a></li>
        <li class="nav-item hidden-sm-up"> <a class="waves-effect waves-dark" href="view.php?link=RBA" aria-expanded="false">
            <i class="fa fa-user"></i><span class="hide-menu"></span></a></li>
        <li class="nav-item hidden-sm-up"> <a class="waves-effect waves-dark" href="view.php?link=REALISASI" aria-expanded="false">
            <i class="fa fa-book"></i><span class="hide-menu"></span></a></li>
        <li class="nav-item hidden-sm-up"> <a class="waves-effect waves-dark" href="view.php?link=DETAIL" aria-expanded="false">
            <i class="fa  fa-bar-chart-o"></i><span class="hide-menu"></span></a></li>
        <li class="nav-item hidden-sm-up"> <a class="waves-effect waves-dark" href="view.php?link=TOP" aria-expanded="false">
            <i class="fa fa-credit-card"></i><span class="hide-menu"></span></a></li> -->
                    </ul>
                     <ul class="navbar-nav my-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php
                                ...
                                echo '<span style="font-size:12px">', $_SESSION['NIP'], '<span>', 
                                '<a href="log_oute.php" class="btn log btn-danger btn-sm"><i class="fa fa-power-off zoom" title="Keluar" style="font-size:14px;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
                                ?>
    ...
    <aside class="left-sidebar">
        <div class="d-flex no-block nav-text-box align-items-center">
            <span><img src="img/icons.png" alt="SIMRA"></span>
            ...
            <nav class="navbar navbar-dark bg-info navbar-expand d-md-none d-lg-none d-xl-none fixed-bottom">
                <ul class="navbar-nav nav-justified w-100">
                    <li class="nav-item zoom">
                        <a href="view.php?link=REALISASI" class="nav-link "><i class="fa fa-plus" style="font-size:22px" title="Grafik Realisasi" data-toggle="tooltip" data-placement="top"></i>&nbsp;&nbsp;</a>
                    </li>
                    <li class="nav-item zoom">
                        <a href="view.php?link=RBA" class="nav-link"><i class="fa fa-user-md" style="font-size:22px" title="RBA" data-toggle="tooltip" data-placement="top"></i>&nbsp;&nbsp;</a>
                    </li>
                    <li class="nav-item zoom">
                        <a href="view.php?link=MAIN" class="nav-link btn-info rounded-pill btn-sm"><i class="fa fa-home" style="font-size:22px;color:white" title="Dashboard" data-toggle="tooltip" data-placement="top"></i>&nbsp;&nbsp;</a>
                    </li>
                    <li class="nav-item zoom">
                        <a href="view.php?link=DETAIL" class="nav-link"><i class="fa fa-history" style="font-size:22px" title="Realisasi Anggaran" data-toggle="tooltip" data-placement="top"></i>&nbsp;&nbsp;</a>
                    </li>
					 <li class="nav-item zoom">
                        <a href="view.php?link=TOP" class="nav-link"><i class="fa fa-shield" style="font-size:22px" title="Top PPTK" data-toggle="tooltip" data-placement="top"></i>&nbsp;&nbsp;</a>
                    </li>
                    <!-- <li class="nav-item">
        <a href="#" class="nav-link"><i class="fa fa-user" ></i>&nbsp;&nbsp;<br>Profile</a>
      </li> -->
                </ul>
            </nav>
    ...
    <footer class="footer" style="text-align: center;font-size:12px">
